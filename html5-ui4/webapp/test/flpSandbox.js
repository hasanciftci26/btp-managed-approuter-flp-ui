		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI 4",
									"targetURL": "#ndbstraininghtml5ui4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ndbstraininghtml5ui4-display": {
								"semanticObject": "ndbstraininghtml5ui4",
								"action": "display",
								"description": "UI 4",
								"title": "UI 4",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ndbs.training.html5ui4",
									"url": sap.ui.require.toUrl("ndbs/training/html5ui4")
								}
							}
						}
					}
